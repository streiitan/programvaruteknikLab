 ...
 */
public class GetLeaguesBySportNameService extends BaseService<List<League>> {
     ...
     *
     * @param sportName, the name of the sport that the selected League should
     * play
     */
    public GetLeaguesBySportNameService(String sportName) {
